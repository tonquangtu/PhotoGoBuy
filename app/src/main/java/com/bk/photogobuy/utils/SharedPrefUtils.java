package com.bk.photogobuy.utils;


import android.content.Context;

import com.bk.photogobuy.application.BaseApplication;
...
public class SharedPrefUtils {
    ...
    public static void putList(List<String> key, String value) {
        BaseApplication.getSharedPreferences().putList(key, value);
    }

    public static String getList(List<String> key, String defValue) {
        return BaseApplication.getSharedPreferences().getList(key, defValue);
    }
